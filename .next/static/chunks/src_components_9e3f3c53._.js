...
"[project]/src/components/odontolink/offers-list.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function OffersList({ offers }) {
    ...
    const filteredAndSortedOffers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OffersList.useMemo[filteredAndSortedOffers]": ()=>{
            let filtered = offers.filter({
                "OffersList.useMemo[filteredAndSortedOffers].filtered": (offer)=>(offer.title.toLowerCase().includes(searchTerm.toLowerCase()) || offer.description.toLowerCase().includes(searchTerm.toLowerCase())) && (category === 'all' || offer.category === category)
            }["OffersList.useMemo[filteredAndSortedOffers].filtered"]);
            switch(sortBy){
                case 'price-asc':
                    filtered.sort({
                        "OffersList.useMemo[filteredAndSortedOffers]": (a, b)=>a.price - b.price
                    }["OffersList.useMemo[filteredAndSortedOffers]"]);
                    break;
                case 'price-desc':
                    filtered.sort({
                        "OffersList.useMemo[filteredAndSortedOffers]": (a, b)=>b.price - a.price
                    }["OffersList.useMemo[filteredAndSortedOffers]"]);
                    break;
            }
            return filtered;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            filteredAndSortedOffers.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(OffersList, "n2VyILoMtMVTsewCDoc7Y3lfTZ0=");
_c = OffersList;
var _c;
__turbopack_context__.k.register(_c, "OffersList");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_components_9e3f3c53._.js.map